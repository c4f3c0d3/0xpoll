    ...
    <Layout>
      <div style={{ padding: '20px' }}>
        ...
        <div class="bill">
          ...
          <a href="https://www.aph.gov.au/Parliamentary_Business/Bills_Legislation/Bills_Search_Results/Result?bId=s1404" class="bill-link">More Information ⌐◨-◨</a>
        </div>
        <div class="bill">
          ...
          <a href="https://www.aph.gov.au/Parliamentary_Business/Bills_Legislation/Bills_Search_Results/Result?bId=r7153" class="bill-link">More Information ⌐◨-◨</a>
        </div>
        <div class="bill">
          <h4 class="bill-title">Australian Naval Nuclear Power Safety Bill 2023</h4>
        ...
        <div class="bill">
          <h4 class="bill-title">Lobbying (Improving Government Honesty and Trust) Bill 2023</h4>
          <p>Establishes a scheme in relation to dealings between lobbyists and Government representatives.</p>
          <a href="https://www.aph.gov.au/Parliamentary_Business/Bills_Legislation/Bills_Search_Results/Result?bId=r7100" class="bill-link">More Information ⌐◨-◨</a>
        </div>
        <div class="bill">
          <h4 class="bill-title">Migration Amendment (Limits on Immigration Detention) Bill 2023</h4>
          ...
          <a href="https://parlinfo.aph.gov.au/parlInfo/search/display/display.w3p;query=Id%3A%22legislation%2Fbillhome%2Fr7112%22" class="bill-link">More Information ⌐◨-◨</a>
        </div>
      </div>
    </Layout>
  );
